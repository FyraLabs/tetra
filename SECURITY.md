...
As such, we constantly try our best to ensure that our infrastructure and process are secure.
...
In the case of a vulnerability in Tetra, you may report it using [GitHub's security advisory system](https://github.com/terrapkg/packages/security/advisories).
